...
const TodoCreate:React.FC<Props> = ({setUpdate}) => {
  ...
  return (
      <div className='w-5/6 h-12 py-4 px-8 mt-8 bg-primary m-auto rounded-full flex align-middle justify-between relative'>
          <input ref={inputRef} type="text" name='newTodo' placeholder="Add Item" className=' w-5/6 bg-transparent text-gray-300 font-semibold border-none outline-none text-md'/>
