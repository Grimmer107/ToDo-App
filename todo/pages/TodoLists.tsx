...
export default function Home() {
    ...
    `${process.env.API_URL}/list?email=${session?.user?.email}` : null, fetcher, { suspense: true })
        ...
        <div className='p-0 relative'>
            ...
            <div className='bg-background p-1 m-auto w-1/2 h-screenset rounded-lg overscroll-none'>
                ...
                <div className='flex justify-between m-auto p-0.5 pl-2 w-5/6 mt-0.5 px-2'>
                    <p className='text-xs text-gray-500 font-bold my-auto pl-4'>TODO LISTS</p>
                    <TodoFilter options={["Public", "Private", "None"]} filter={filter} setFilter={setFilter} />
                </div>
