    ...
    return (
        <div>
            ...
            <div className='w-1/3 m-auto mt-36 px-10 py-12 rounded-md text-gray-300 bg-primary flex flex-col justify-items-center align-middle '>
                <p className='w-1/4 p-1 text-center m-auto text-white font-semibold text-lg'>Sign in</p>
                ...
                <button onClick={onClickHandle} className='mt-10 w-2/4 m-auto rounded-full bg-blue-600 text-white py-1 text-md hover:bg-blue-700'>Login</button>
                <p className='mt-10 text-sm m-auto cursor-pointer hover:underline' onClick={onRegisterHandler}>
